...
public class Sell_Return extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Sell_Return frame = new Sell_Return("Nuhin");
	 ...
	 * Create the frame.
	 */
	public Sell_Return(String user_name) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sell_Return.class.getResource("/version1/logomaker.png")));
		setTitle("Sell Return");
		...
		label_3.setIcon(new ImageIcon(Sell_Return.class.getResource("/version1/logomaker.png")));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(240)
					.addComponent(label_3, GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE)
					.addGap(243))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(45)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(11)
					.addComponent(label_3, GroupLayout.DEFAULT_SIZE, 292, Short.MAX_VALUE)
					.addGap(8)
